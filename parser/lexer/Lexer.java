...
public class Lexer {
  ...
  public Token makeToken( String s, int startPosition, int endPosition ) {
    ...
    Token ret = new Token( startPosition, endPosition, sym, source.getLineno() );
    return ret;
  }
  ...
  public Token nextToken() {
    ...
    if( Character.isDigit( ch )) {
      ...
      try {
        do {
          ...
          // check for scientific literal
          if(ch == '.'){
            String sciLit = number;
              do{
                endPosition++;
                sciLit += ch;
                ch = source.read();
                if(ch == 'e' || ch == 'E'){
                  ...
                  if(ch == '+' || ch == '-'){
                    ...
                    Token ret = new Token(startPosition, 
                    endPosition, 
                    Symbol.symbol(sciLit, Tokens.ScientificLit),
                    source.getLineno()
                    );
    ...
    if(ch == '`'){
      ...
      Token ret = new Token(
        startPosition, 
        endPosition, 
        Symbol.symbol(charLit, Tokens.CharLit),
        source.getLineno()
      );
  ...
  //       }
  //     }while( lex.source != null );

  //     System.out.println(lex);
  //   } catch (Exception e) {System.out.println("usage: java lexer.Lexer \"filename.x\"");}
  // }
